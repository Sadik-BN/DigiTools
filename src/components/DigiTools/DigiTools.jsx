...
const DigiTools = ({ dataPromise, added, setAdded, total, setTotal }) => {
    ...
    return (
        <div className="container mx-auto px-10 mt-30">
            ...
            <Suspense fallback={<div className="flex justify-center items-center"><span className="loading loading-spinner loading-xl"></span></div>}>
                <Products added={added} setAdded={setAdded} dataPromise={dataPromise} tab={tab} total={total} setTotal={setTotal}></Products>
            </Suspense>

            <Cart added={added} setAdded={setAdded} tab={tab} total={total} setTotal={setTotal}></Cart>
